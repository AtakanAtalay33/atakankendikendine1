    ...
    public partial class tablolareklendi : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeCars", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeCars_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeCars_Employees_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeCars_CarId",
                table: "EmployeeCars",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeCars_EmployeeId",
                table: "EmployeeCars",
                column: "EmployeeId");
        }
